...
parser.add_argument("--max_source_seq_len", default=512, type=int,
                    help="The maximum total encoder input sequence length after tokenization. Sequences longer "
                         "than this will be truncated, sequences shorter will be padded.", )
parser.add_argument("--max_target_seq_len", default=512, type=int,
                    help="The maximum total decoder input sequence length after tokenization. Sequences longer "
                         "than this will be truncated, sequences shorter will be padded.", )
...
def main():
    reset_console()
    tokenizer = AutoTokenizer.from_pretrained("/root/autodl-tmp/znn/chatglm-model/chatglm-6b_model",
                                              trust_remote_code=True)
    model = ChatGLMForConditionalGeneration.from_pretrained(
        "/root/autodl-tmp/znn/chatglm-model/chatglm-6b_model",
        load_in_8bit=False,
        trust_remote_code=True
    )
